...
$sql = " UPDATE cardrequests SET response = 's' WHERE id = '$id'";
$result = mysqli_query($db,$sql);

$sql3 = "select * from cardrequests where id = '$id'";
...
if($result10){
	$sql5 = "INSERT INTO `cardspending` (`accountnumber`, `balanceamount`, `Id`) VALUES ('$accountnumber', '$amount', '$id'); ";
